          ...
          <el-form-item class="input" label="岗位" prop="gangwei">
              <el-input v-model="ruleForm.gangwei" 
                placeholder="岗位" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="指导人" prop="zhidaoren">
          <el-input v-model="ruleForm.zhidaoren" 
              placeholder="指导人" clearable  :readonly="ro.zhidaoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="指导人" prop="zhidaoren">
              <el-input v-model="ruleForm.zhidaoren" 
                placeholder="指导人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
