<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="日记编号" prop="rijibianhao">
            <el-input v-model="ruleForm.rijibianhao" 
                placeholder="日记编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.rijibianhao" label="日记编号" prop="rijibianhao">
              <el-input v-model="ruleForm.rijibianhao" 
                placeholder="日记编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="添加时间" prop="tianjiashijian">
          <el-input v-model="ruleForm.tianjiashijian" 
              placeholder="添加时间" clearable  :readonly="ro.tianjiashijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="添加时间" prop="tianjiashijian">
              <el-input v-model="ruleForm.tianjiashijian" 
          ...
          <el-form-item class="input" label="学生姓名" prop="xueshengxingming">
              <el-input v-model="ruleForm.xueshengxingming" 
                placeholder="学生姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日记标题" prop="rijibiaoti">
          <el-input v-model="ruleForm.rijibiaoti" 
              placeholder="日记标题" clearable  :readonly="ro.rijibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="日记标题" prop="rijibiaoti">
              <el-input v-model="ruleForm.rijibiaoti" 
                placeholder="日记标题" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="今日体会" prop="jinritihui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="今日体会"
                  v-model="ruleForm.jinritihui" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinritihui" label="今日体会" prop="jinritihui">
                    <span>{{ruleForm.jinritihui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="今日收获" prop="jinrishouhuo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="今日收获"
                  v-model="ruleForm.jinrishouhuo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinrishouhuo" label="今日收获" prop="jinrishouhuo">
                    <span>{{ruleForm.jinrishouhuo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `shixiriji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shixirijiCrossAddOrUpdateFlag = false;
                  this.parent.search();
